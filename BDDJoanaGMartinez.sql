...
INSERT INTO `dueno` VALUES (12345,'Zoe','Burgos',54321,'Libertad 123');
...
CREATE TABLE `perro` (
  ...
  KEY `fk_pd` (`DNI_dueno`),
  CONSTRAINT `fk_pd` FOREIGN KEY (`DNI_dueno`) REFERENCES `dueno` (`DNI`)
...
INSERT INTO `perro` VALUES (1,'Luna','2023-05-06','Hembra',12345);
...
-- Dump completed on 2022-08-11 21:26:24
